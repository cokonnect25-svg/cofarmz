...
import {ArrowLeft, Building2, ChevronRight, Plus, Search, Users} from 'lucide-react';
...
export default function DigitalFposPage() {
  ...
  return <main className="max-w-4xl mx-auto p-4 pb-24 space-y-5 text-gray-800">
    <Link href="/user-profile" className="inline-flex items-center gap-2 text-sm font-bold text-gray-500"><ArrowLeft size={18}/>Back to profile</Link>
    ...
    {data.can_manage&&<section className="border border-gray-100 bg-white shadow-soft rounded-2xl p-5 space-y-4"><h2 className="font-bold text-xl">Assignment and publishing tools</h2><p>Select a district to correct assignments. Select an FPO above to manage its status or publish an announcement.</p>
