...
public class MainActivity extends BridgeActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // ✅ Online: intercept any WebView load errors mid-session
        getBridge().getWebView().setWebViewClient(new WebViewClient() {
            @Override
            public void onReceivedError(WebView view, WebResourceRequest request,
                                        WebResourceError error) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    // Only intercept main frame errors (not sub-resource errors)
    ...
    private void showOfflinePage() {
        String html = "<!DOCTYPE html><html><head>"
            ...
            + "align-items:center; justify-content:center; font-family:sans-serif; padding:24px; }"
            ...
            + "h1 { color:#fff; font-size:28px; font-weight:900; text-align:center;"
